                    ...
                    <div class="modal-title">
                        ...
                        <div class="text-center">
                            ...
                            <div class='btn-group settingsBtnGrp' role='group' aria-label='Buttons'>
                                ...
                                <button type='button' class="btn btn-primary btn-save" id='settingsSubmit' value='Submit Changes'>Save and Reload</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-body">
                    ...
                    <div id="instructionsContainer" class="alert alert-info">
                        ...
                        <p>If you want to go directly to a specific app within Muximux you can use hashes (<code>#</code>) in the URL.
                            ...
                            <code>
                                <script>
                                    document.write(location.href.replace(location.hash, ""))
                                </script>#My app
                            </code><br /><br />
                        ...
                        <p>See:
                            <a href="https://chrome.google.com/webstore/detail/ignore-x-frame-headers/gleekbfjekiniecknbkamfmkohkpodhe" target="_blank">https://chrome.google.com/webstore/detail/ignore-x-frame-headers/gleekbfjekiniecknbkamfmkohkpodhe</a>
                        </p>
                    ...
                    <div id="backupiniContainer" class="alert alert-warning">
                        ...
                        <hr />
                        <div id="backupContents">
                            <pre><?php if (file_exists('backup.ini.php')) echo htmlentities(file_get_contents('backup.ini.php')); ?></pre>
                        </div>
                    </div>
                    <?php echo parse_ini(); ?>
                </div>
    ...
    <div id="splashModal" class="modal keyModal" role="dialog" data-keyboard="true">
        <div class="modal-dialog splashDialog">
            ...
            <div class="modal-header splashHeader">
                ...
                <div id="splashNav">
                    <button type="button" id="splashSettings" class="splashNavBtn btn btn-primary btn-lg" data-dismiss="modal"><span class="fa fa-cog icon-4x"></span> Settings</button>
                    <button type="button" id="splashLog" class="splashNavBtn btn btn-primary btn-lg" data-dismiss="modal"><span class="fa fa-file-text-o icon-4x"></span> Log File</button>
                    <button type="button" id="splashLogout" class="splashNavBtn btn btn-primary btn-lg"><span class="fa fa-sign-out icon-4x"></span> Logout</button>
                </div>
